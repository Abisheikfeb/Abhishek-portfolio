...
const Navbar = ({ onLogin, user }) => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-4xl bg-white/95 backdrop-blur-md border-2  border-red-600 shadow-xl rounded-full px-6 py-2 flex items-center justify-between mt-5 relative z-[110]">
